---
description: "Prompt engineering specialist - generates comprehensive, autonomous prompts for the coordinator agent. Transforms user requirements into structured prompts with all context pre-loaded so the coordinator never asks questions."
mode: primary
examples:
  - "Use when you need a comprehensive prompt for the coordinator agent"
  - "Use when you want the coordinator to execute without stopping or asking questions"
  - "Use for complex tasks that need structured phase breakdowns and agent loops"
---
