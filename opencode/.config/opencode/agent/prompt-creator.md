...
examples:
  ...
  - "Use to craft subagent call prompts (planner → implementer → analyzer) with success criteria"
---
...
- Clarification Emphasis: Use `question` for interactive clarification questions (never ask in plain text)
