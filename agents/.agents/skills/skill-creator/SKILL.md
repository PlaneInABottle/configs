...
When editing the (newly-generated or existing) skill, remember that the skill is being created for another AI assistant to use. Include information that would be beneficial and non-obvious to the AI assistant. Consider what procedural knowledge, domain-specific details, or reusable assets would help another AI assistant instance execute these tasks more effectively.
